...
<style>
    ...
    .bgimg-1 {
        ...
        background-image: url("images/manBroadArms.jpg");
        min-height: 100%;
    }
    ...
    .parallax1 {
        /* The image used */
        background-image: url("images/girlLifting.jpg");
    ...
    .parallax2 {
        /* The image used */
        background-image: url("images/manLifting.jpg");
...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-white w3-card" id="myNavbar">
            <img src="images/KMHLogo.png" href="index.html" class="w3-bar-item w3-button w3-wide"
